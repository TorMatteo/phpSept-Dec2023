...
foreach ($utilisateurs as $utilisateur){
    echo '<p>  
<a href="https://webinfo.iutmontp.univ-montp2.fr/~tordeuxm/td-php/TD9/web/controleurFrontal.php?controleur=utilisateur&action=afficherDetail&login='.
...
<a href="https://webinfo.iutmontp.univ-montp2.fr/~tordeuxm/td-php/TD8/web/controleurFrontal.php?controleur=utilisateur&action=afficherFormulaireMiseAJour&login='
    ...
    echo '<p> <a href="https://webinfo.iutmontp.univ-montp2.fr/~tordeuxm/td-php/TD9/web/controleurFrontal.php?controleur=utilisateur&action=afficherFormulaireCreation"> Creer utilisateur </a></p>';
?>
</body>
</html>
