...
echo '<p> <a href="https://webinfo.iutmontp.univ-montp2.fr/~tordeuxm/td-php/TD9/web/controleurFrontal.php?controleur=utilisateur&action=afficherFormulaireMiseAJour&login='
    .rawurlencode($utilisateur->getLogin()).'"> MAJ </a> | 
<a href="https://webinfo.iutmontp.univ-montp2.fr/~tordeuxm/td-php/TD9/web/controleurFrontal.php?controleur=utilisateur&action=supprimer&login='
